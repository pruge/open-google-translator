...
```javascript
import {translate, supportedLanguages} from 'open-google-translator';
...
- `supportedLanguages();` this method will provide pair of language iso639-1 language codes with respective language original names
